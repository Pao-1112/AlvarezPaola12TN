...
public class WebAuthorization extends WebSecurityConfigurerAdapter { // Maneja las reglas del servidor
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST,"/api/clients/current","/api/clients/current/accounts", "/api/transactions","/api/clients/current/cards").hasAnyAuthority("ADMIN","CLIENT")
                .antMatchers("/api/clients/{id}","/api/accounts/{id}","/api/cards/{id}", "/web/cards.html", "/web/js/cards.js","/web/create-cards.html", "/web/js/create-cards.js","/web/transfers.html", "/web/js/transfers.js").hasAnyAuthority("ADMIN", "CLIENT")
